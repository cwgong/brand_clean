...
class BrandRecallOpt(object):
    ...
    def brand_recall(self, output_file="brand_recall_info_tmp.txt"):
        try:
            ex_brand_dict = tool.get_exchange_brand_pair()
            ...
            # 硬添加【米家】添加一级类目【家用电器】
            mijia_lst += ["\t".join(["10698337","MIJIA/米家", self.english_brand_extension("MIJIA/米家/小米米家"), "100031", "家用电器", "0.0"])]
            mijia_lst += ["\t".join(["10698337", "MIJIA/米家", self.english_brand_extension("MIJIA/米家/小米米家"), "100034", "家装建材", "0.0"])]
