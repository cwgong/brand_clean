...
import configparser
import json
from  brand_reg_toolkit_v1 import BrandInfoLoading, BrandRefRuleOpt
...
class BrandRegTool(object):
    def __init__(self, standard_brand_file, del_brand_file=None, exchange_brand_file=None, rule_brand_file=None):
        ...
        try:
            ...
            #直接读取进行过品牌扩展的文件
            self.brand_idx_dict, self.idx_ori_brand_dict, self.brand_cat1_dict, \
    ...
    def getting_high_gmv_brand(self, same_cat1_bid_lst):
        ...
        for y in same_cat1_bid_lst:
            tmp_gmv_lst.append((self.brand_gmv_dict[y], self.idx_ori_brand_dict[y], y))
    ...
    def same_cat1_strategy(self, cat1_id, clean_brand_lst, clean_brand_id_lst):
        ...
        for b in clean_brand_id_lst:
            tmp_name_lst.append(self.idx_ori_brand_dict[b])

        same_cat1_bid_lst = []
        for y in same_id_lst:
            if cat1_id in self.brand_cat1_dict[y]:
                pre_brand = self.idx_ori_brand_dict[y]
                pre_brand_id = y
    ...
    def brand_recognition(self, line_str):
        ...
        try:
            ...
            # s_name小写字母
            s_name = tool_v1.s_name_dealing("%s %s" % (ori_product_name, ori_brand_word))
            clean_brand_lst = []
            clean_brand_id_lst = []
            ...
            for ori_b_str, same_brand_id_lst in self.brand_idx_dict.items():
                ...
                b, is_eng = lst_z
                if is_eng == "0" and tool_v1.is_own_eng(s_name) and b in s_name:
            ...
            if len(clean_brand_id_lst) == 1:
                ...
                return b_id, \
                       self.idx_ori_brand_dict[clean_brand_id_lst[0]], \
